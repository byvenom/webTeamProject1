   ...
   <div id="footer-wrapper">
      <div id="footer-content">
         <div id="fbox4">
            ...
            <div align="center">
                <br> <br>
					<c:if test="${!(userid==null || userid=='')}"><button type="button" onclick="location.href='cat_insert.do'">글
						작 성</button></c:if>
               ...
               <c:if test="${page > block }">
                [<a href="cat_search.do?page=1&find_field=${find_field}&find_name=${find_name}">◀◀</a>]
                [<a href="cat_search.do?page=${startBlock-1 }&find_field=${find_field}&find_name=${find_name}">◀</a>]
             </c:if>
             ...
             <c:forEach begin="${startBlock }" end="${endBlock }" var="i">
                ...
                <c:if test="${!(i == page) }">
                   [<a href="cat_search.do?page=${i }&find_field=${find_field}&find_name=${find_name}">${i }</a>]
                
                </c:if>
             </c:forEach>
                
                <c:if test="${endBlock < allPage }">
                   [<a href="cat_search.do?page=${endBlock +1 }&find_field=${find_field}&find_name=${find_name}">▶</a>]
                   [<a href="cat_search.do?page=${allPage }&find_field=${find_field}&find_name=${find_name}">▶▶</a>]
                </c:if>
            </div>
   ...
   <div id="page-wrapper">
      <div id="page">
         <div id="content" style="height: 24px">
            <div>
               <form method="get"
                  action="<%=request.getContextPath()%>/cat_search.do">
