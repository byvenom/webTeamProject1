         ...
         <div id="fbox4">
            ...
            <div align="center">
               ...
               <c:if test="${page > block }">
                [<a href="free_board.do?page=1">◀◀</a>]
                [<a href="free_board.do?page=${startBlock-1 }">◀</a>]
             </c:if>
             ...
             <c:forEach begin="${startBlock }" end="${endBlock }" var="i">
                ...
                <c:if test="${!(i == page) }">
                   [<a href="free_board.do?page=${i }">${i }</a>]
                
                </c:if>
             </c:forEach>
                
                <c:if test="${endBlock < allPage }">
                   [<a href="free_board.do?page=${endBlock +1 }">▶</a>]
                   [<a href="free_board.do?page=${allPage }">▶▶</a>]
                </c:if>
            </div>
            ...
            <div>
               <form method="get"
                  ...
                  <select name="find_field" style="height: 40px; padding: 5px;">
                     ...
                     style="height: 35px; padding: 2px; width: 240px;">&nbsp;&nbsp; <button type="submit">검 색</button>
               </form>
            </div>
         </div>
         <div id="sidebar">
