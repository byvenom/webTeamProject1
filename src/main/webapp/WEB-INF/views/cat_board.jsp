         ...
         <div id="fbox4">
            ...
            <div align="center">
               ...
               <c:if test="${page > block }">
                [<a href="cat_board.do?page=1">◀◀</a>]
                [<a href="cat_board.do?page=${startBlock-1 }">◀</a>]
             </c:if>
             ...
             <c:forEach begin="${startBlock }" end="${endBlock }" var="i">
                ...
                <c:if test="${!(i == page) }">
                   [<a href="cat_board.do?page=${i }">${i }</a>]
                
                </c:if>
             </c:forEach>
                
                <c:if test="${endBlock < allPage }">
                   [<a href="cat_board.do?page=${endBlock +1 }">▶</a>]
                   [<a href="cat_board.do?page=${allPage }">▶▶</a>]
                </c:if>
            </div>
