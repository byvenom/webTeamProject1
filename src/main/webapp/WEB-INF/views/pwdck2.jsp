	...
	<div id="footer-wrapper">
		<div id="footer-content">
			<div align="center">
				...
				<tr><td><br><br></td></tr>
				<tr><td colspan="2" align="center"><button type="button" onclick="delete2('${pwd}')">확 인</button>&nbsp;&nbsp;&nbsp;<button type="button" onclick="location.href='mypage.do?id=${id}'">이 전</button></td></tr>
				</table>
