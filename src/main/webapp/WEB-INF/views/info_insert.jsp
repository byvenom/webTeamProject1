...
<body>
	...
	<div id="footer-wrapper">
		<div id="footer-content" style="height: 1000px">
			<div id="fbox4">
				<h2 align="center">
					지식<span>&nbsp;게시판 글 작성</span>
				</h2>
				<form id="sub1" method="post" 
					action="<%=request.getContextPath()%>/info_insert_ok.do"
					...
					<table width="1000" border="1" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td><select name="cate" style="height: 24px"
								>
									<option value="dogInfo" selected="selected">강아지 정보</option>
									<option value="catInfo" >고양이 정보</option>
							</select></td>
						</tr>
						<tr>
							<th>제 목</th>
