	...
	<div id="footer-wrapper">
		<div id="footer-content">
			<div id="fbox4">
                ...
                [<a href="dog_board.do?page=1">◀◀</a>]
                [<a href="dog_board.do?page=${startBlock-1 }">◀</a>]
             </c:if>
					...
					<c:forEach begin="${startBlock }" end="${endBlock }" var="i">
						...
						<c:if test="${!(i == page) }">
                   [<a href="dog_board.do?page=${i }">${i }</a>]
                
                </c:if>
					</c:forEach>

					<c:if test="${endBlock < allPage }">
                   [<a href="dog_board.do?page=${endBlock +1 }">▶</a>]
                   [<a href="dog_board.do?page=${allPage }">▶▶</a>]
                </c:if>
				</div>
			...
			<div id="content" style="height: 24px">
				<div>
					<form method="get"
						...
						<input type="hidden" value=${page } name="page"> <select
							name="find_field" style="height: 40px; padding: 5px;">
